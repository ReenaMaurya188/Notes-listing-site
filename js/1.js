...
addBtn.addEventListener("click", function (e) {              //addevent on element with id addBtn when it is clicked
    ...
    let addTitle = document.getElementById("addTitle");         //to display cards now , created blank html
    ...
    notesObj.push(myObj);                                //values entered in textarea store in notesObj with help of id addTxt
    localStorage.setItem("notes", JSON.stringify(notesObj));    //setNotesObj in localstorage in array stringFormat  
    addTxt.value = "";
    addTitle.value = "";                                          //make textarea as blank to add new note
